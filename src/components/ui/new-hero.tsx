...
// headline: smooth line reveal + subtle word stagger
const lineVariants = {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        {/* right spotlight behind headline */}
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1fr_1fr]">
          ...
          >
            ...
            <div className="group relative h-72 w-72">
              {/* outer glow that reacts on hover */}
              <div
                className="
                  pointer-events-none absolute inset-[-18px] rounded-full
                  bg-[radial-gradient(circle,_rgba(129,140,248,0.18),transparent_62%)]
                  blur-2xl opacity-60 transition-opacity duration-500
              ...
              <motion.div
                ...
                className="
                  ...
                  bg-[conic-gradient(from_210deg,_rgba(99,102,241,0.80),_rgba(129,140,248,0.55),_rgba(34,211,238,0.55),_rgba(99,102,241,0.80))]
              ...
              <div
                className="
                  absolute inset-[9px] overflow-hidden rounded-full
                  bg-white/[0.04]
