    ...
    <form onSubmit={onSubmit} className="relative flex items-center justify-center w-full">
      <div className="relative flex items-center justify-center group w-full">
        ...
        <div className="relative group w-full">
          ...
          {/* Pink ambient glow */}
          <div className="pointer-events-none w-[24px] h-[16px] absolute bg-[#cf30aa] top-[8px] left-[4px] blur-2xl opacity-70 transition-all duration-[2000ms] group-hover:opacity-0" />
          ...
          {/* Send button with spinning border */}
