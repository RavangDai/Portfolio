...
const bentoGridVariants = cva(
  "relative grid gap-4 [&>*:first-child]:origin-top-right [&>*:nth-child(3)]:origin-bottom-right [&>*:nth-child(4)]:origin-top-right",
  {
    variants: {
      variant: {
        default: `
          grid-cols-8 grid-rows-[1.5fr_1fr_1fr] md:grid-rows-[1fr_0.5fr_0.5fr_1fr]
          [&>*:first-child]:col-span-8 md:[&>*:first-child]:col-span-6 md:[&>*:first-child]:row-span-3
          [&>*:nth-child(2)]:col-span-4 md:[&>*:nth-child(2)]:col-span-2 md:[&>*:nth-child(2)]:row-span-2
          [&>*:nth-child(3)]:col-span-4 md:[&>*:nth-child(3)]:col-span-2 md:[&>*:nth-child(3)]:row-span-2
